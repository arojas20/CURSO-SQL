...
y materias primas que requiera la quesera para producir sus productos o los servicios necesarios para ello*/
 ...
 de produccion de loss productos en la quesera*/
 ...
 venden en la quesera, sin importar sio se producen o no en ella*/
...
/* Se crea la tabla PRODCLI que tendra los datos claves oara relacionar las tablas de CLIENTES con los
